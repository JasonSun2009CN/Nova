...
- 交付新阶段时 **同步刷新三处**：本文档 + `HANDOFF.md` + `docs/ROADMAP.md`（现状已交付至 S21 Phase 2 收尾 + 增量 3 变动出发地，规划至 S38）。
...
| Phase 3 | v0.3.0 | 完整航行系统 + 相对论视觉      | S22~S29                                                    | 🚧 S22、S23 已提交未合并（S25 仪表盘随 S23 提前）；S24、S26~S29 已规划                |
