...
import type { ConstellationIauCode } from './constellations';

export { CONSTELLATION_IAU_CODES } from './constellations';
export type { ConstellationIauCode } from './constellations';
